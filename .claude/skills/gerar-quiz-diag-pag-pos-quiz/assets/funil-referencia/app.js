/* ============================================================
   APP. Motor do funil (render, validacao, persistencia, tracking).
   REFERENCIA DA SKILL: este arquivo carrega todas as correcoes de bug de
   producao. Copie inteiro e mexa o minimo. Os comentarios em CAIXA ALTA
   marcam trechos que ja quebraram em cliente real.
...
const LEADS_ENDPOINT = "";   // <<< webhook do Make do cliente. Vazio = nao envia.
