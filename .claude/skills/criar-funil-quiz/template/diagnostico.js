/* ============================================================
   ...
   ESTRUTURA reutilizável (mantenha): qualificação (foraDeArea/nutrir)
   adapta o CTA; CTAs distribuídos pela página (classe .cta-wpp);
   galeria de depoimentos; bloco final.
   COPY: o texto das seções abaixo é um EXEMPLO (nicho emocional).
   Ajuste ao nicho do cliente. STORE_KEY deve bater com config.storeKey.
...
if (!a._completedAt && !a.problema) {
  ...
  report.innerHTML = `
    ...
    <div class="etapa">
      <h3>Antes de tudo</h3>
      <p>Oi, ${nome}! Aqui é da nossa equipe. 💛 Li com atenção tudo o que você
    ...
    <div class="etapa">
      ...
      <p>__SUA ABORDAGEM/MÉTODO__, num acompanhamento individual e
    ...
    <div class="etapa">
      ...
      <p>Pessoas reais que viveram a transformação:</p>
      <div class="depo-gallery">
        <!-- DEPOIMENTOS: coloque os prints/avaliações do cliente em ./depoimentos/01.jpeg, 02.jpeg...
             Prefira avaliações públicas (Google 5 estrelas) e prints de WhatsApp que casem com a
             narrativa do funil. Imagens INTEIRAS (não cortar). Repita uma linha por depoimento: -->
      ...
      <p class="hint">O que essas histórias têm em comum: a pessoa foi na causa, não só no sintoma.</p>
    </div>
