...
| **Carrossel de Instagram** (`carrossel-instagram`) | Skill (automática) | Pega um tema ou uma **copy aprovada** e monta um **carrossel 4:5** na identidade do cliente (cor, fonte, logo, @), com preview em frame do Instagram pra você deslizar e revisar. No fim, **exporta cada slide em PNG 1080x1350** pronto pra subir no feed. Pergunta a identidade da marca antes, não inventa. | Peça: *"monta um carrossel sobre X pro cliente Y"* ou *"transforma essa copy em carrossel"*. |
