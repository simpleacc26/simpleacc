...
| `/mesa-de-guerra` | Conselho estratégico (Brunson, Hormozi, Luiz Filho, Matuta) para decisão de negócio: oferta, escala, time, operação, caixa, crise. Conduz diagnóstico → análise dos 4 → síntese com prioridades. |
