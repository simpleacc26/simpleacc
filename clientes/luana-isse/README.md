...
Jornalista, copywriter, estrategista digital e master coach. Ajuda especialistas a construir
movimento, causa e posicionamento — método próprio **MMPV™** (Matriz da Identidade, Movimento,
Posicionamento, Vendas). Cliente de consultoria de aquisição da Simple Acc desde julho/2026.

**O que a Simple entrega:** roadmap estratégico de 90 dias, funil de lead dinâmico (quiz +
páginas + copies + criativos + tráfego), playbooks comerciais e acompanhamento quinzenal
(individual e em grupo) por 1 ano.
...
- `estrategia/2026-08-04-roadmap-estrategico-luana-isse-v1-1.html` e `.pdf` — **Roadmap de 90 dias
  vigente (v1.1).** Fonte editável no HTML.
- `estrategia/2026-07-30-roadmap-estrategico-luana-isse.html` e `.pdf` — v1.0, superada
...
- Trabalha **só à tarde/noite** — Deus e família vêm antes; não trabalha de manhã. Qualquer
  processo desenhado para ela precisa caber nessa janela.
- Caixa apertado no início do projeto: priorizar monetização da base existente (17 alunos da
  MMPV + indicações de político) antes de escalar tráfego.
- Canvas do Cliente Ideal ainda em branco em 29/07 — será preenchido na call de onboarding.
