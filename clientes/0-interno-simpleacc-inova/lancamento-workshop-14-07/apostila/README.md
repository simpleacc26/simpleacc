...
~2h28) + o **deck da apresentação** (`aula-deploy`). Conteúdo do método **não inventado**, extraído da fonte, com números e falas reais.

## Estrutura da apostila (realinhada ao deck)

- **Parte 0 · A prova**, cases e números (Carol MQL R$32 · Daniele MQL R$5 a 6 · Ju ROAS 8,4 ·
  contratos R$30 a 84k · faturamento mês a mês da operação própria).
...
Cada parte traz **checklists de execução** e **templates preenchíveis** (oferta, buckets,
