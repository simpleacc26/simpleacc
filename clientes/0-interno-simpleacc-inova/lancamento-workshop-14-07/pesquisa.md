...
> perfil/renda → atribuição → qualificação → abertas), adaptada pro nosso público
...
- **Como você se define hoje?** *
  - Mentor(a) / consultor(a)
  - Expert / infoprodutor(a)
  - Prestador(a) de serviço
  - Dono(a) de negócio / agência
  - Ainda estou começando
- **O que você vende / seu nicho?** * (texto curto)
- ⭐ **Seu faturamento médio mensal hoje?** *
  - Ainda não faturo / até R$ 10 mil
  - R$ 10 mil a R$ 50 mil
...
- **O que você espera resolver com o Funil de Lead Dinâmico?** * (texto)
- **Se você resolvesse isso, o que mudaria no seu negócio nos próximos 6 meses?** (texto)

---

## Uso da pesquisa
- **Segmentação de aquecimento:** quem marca *R$50k+*, *ticket R$10k+* e *escala
  tráfego* entra em ênfase de aplicação já em D+1; demais recebem mais aquecimento.
- **Atribuição:** "Como você chegou" alimenta a leitura de canal do Renan.
- **Fila do SDR:** as respostas + a etiqueta da Aplicação (`aplicacao.md`) priorizam
  quem chama primeiro.
- **Integração:** Form → planilha de respostas (Google Sheets) vinculada e testada.
