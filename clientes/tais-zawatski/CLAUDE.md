# Cliente: Taís Zawatski

Esta pasta é a **base de conhecimento** do cliente Taís Zawatski. Tudo que a SimpleAcc
...
4. Trabalhe numa branch `cliente/tais-zawatski/<assunto>` e abra PR.
