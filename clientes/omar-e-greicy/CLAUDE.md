# Cliente: Omar e Greicy (clínica de harmonização facial — Chapecó/SC)
...
4. Branch `cliente/omar-e-greicy/<assunto>` + PR.
...
- **Gargalo principal:** **volume de leads (topo de funil)**. A conversão de
  quem chega na clínica é alta — "quem vem, a gente fecha".
- **Aquisição hoje:** indicação + Instagram orgânico (~1.500 contas por post,
  2 posts/dia) + impulsionamento de publicação (feito por eles, sem estratégia).
  Único teste pago relevante: **"Clube do Botox"** (~R$ 200 investidos → muita
  gente chamou, 1–2 fecharam a R$ 1.940).
- **Retenção:** desconto para quem marca a clínica no Instagram e desconto por
  indicação — funciona. Perdem cliente de preenchimento (ciclo ~1 ano); o Botox
  é o que traz de volta.
- **Concorrência:** clínicas de estética da cidade (biomédicas, enfermeiras com
