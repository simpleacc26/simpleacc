# Legendas globais para Meta Ads
...
O criativo é quem carrega a cena específica (a pessoa que você deveria ter
trocado, a reunião que não virou execução, a promoção que não deu certo). Por
isso a legenda **não** nomeia cena nenhuma: se nomeasse, deixaria de ser global e
brigaria com metade dos criativos. O que ela faz é o que a arte não consegue —
filtrar cargo e porte logo na primeira linha, desqualificar o iniciante com o
bloco "você já tentou", e fechar no pedido pequeno.

## Modelo 1 — o filtro e o que já foi tentado

> Você que é dono ou sócio de uma empresa acima de R$200 mil por mês: daqui pra
> frente, o que trava o crescimento raramente está na venda. Está na decisão
> sobre gente. E não é porque falta gente boa no teu time — é porque a régua de
> como se decide nessa empresa continua existindo só dentro da tua cabeça.
>
> Você provavelmente já conversou, já cobrou mais de perto, já trocou quem não
> estava entregando, já colocou processo e ferramenta. E voltou ao mesmo lugar em
...
> a que você queria ter daqui a um ano.
>
> E não é falta de capacidade: você decide sobre dinheiro, contrato e risco toda
> semana sem hesitar. Decisão sobre gente é a única que não tem número pra te
...
## Por que essas duas, e não duas variações da mesma

Elas testam coisas diferentes, o que é o ponto de ter só duas rodando.

A **1** ataca pela cena reconhecida: o lead se vê no que já tentou e conclui
sozinho que o problema não é esforço. É a linha dos criativos v4, e serve de
controle.

A **2** ataca pela estatística. O número não é inventado nem de mercado: sai da
pergunta 3 do próprio quiz, com 176 respostas — 80,1% decidem por experiência,
bom senso, intuição ou reação, contra 19,9% que usam critério claro e método
...
- **Sem quantidade de perguntas e sem minutagem.** "Poucas perguntas" resolve, e
  ...
  passou duas semanas com 3 e 5 minutos convivendo por causa disso.
...
Botão sugerido: "Saiba mais". O CTA do texto já conduz ao clique, então não
precisa repetir "clique no link" — repetir só gasta caractere.

O primeiro parágrafo é o que aparece antes do "ver mais" no feed. As duas
legendas abrem pelo filtro de propósito: quem não é o público para de ler ali, e
é isso que se quer.

**Uma nuance do fecho:** "sem vendedor no meio" é verdade e "sem falar com
ninguém" não é mais. No funil de hoje o lead vê o cenário na tela na hora, mas
para receber o documento ele manda uma mensagem no WhatsApp. As duas legendas
dizem isso explicitamente, e é melhor assim — prometer que não precisa falar com
ninguém e depois pedir uma mensagem cria atrito bem no ponto mais caro do funil.
