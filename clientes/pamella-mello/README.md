...
ociosa. O trabalho da Simple Acc é **instalar máquina comercial e métrica** —
não é vender tráfego.

- **Início:** call de fechamento 09/06/2026 · onboarding 12/06/2026.
- **Segmento:** saúde emocional / hipnoterapia.
- **Modelo:** tratamento de 3 meses · ticket médio R$3.500–4.000 · avaliação R$150.
...
- [Planilha de Acessos](https://drive.google.com/file/d/1tUhjVzdZEZm-OpIjJQrMglEEhkWSi6Eg/view) · [Planilha de Leads](https://docs.google.com/spreadsheets/d/1Fkiy81SpYNXzaoD_Zi_SStP2rkpKBRcT250x7E2GGe8/edit)
...
- **Fase 2 (30–60d):** qualificação → quiz/filtro de renda e intenção; subir
  conversão da avaliação de ~31% para 45–50%.
- **Fase 3 (60–90d):** esteira/upsell + programa de indicação + escala controlada.

> Ainda **sem projeto de código** nesta pasta. Ao criar o primeiro (ex.: quiz,
> landing), copie `_modelo/projeto/` para `clientes/pamella-mello/<projeto>/` e
> registre na tabela acima.
...
**Funil atual (jun/26):** ~R$2.000/mês de tráfego → WhatsApp direto (sem
qualificação/rastreio); 38 avaliações → 12 fechamentos (~31,5%); follow-up fraco
