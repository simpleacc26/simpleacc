...
- Pasta no Drive: [Simple <> João Mendes](https://drive.google.com/drive/folders/15cxwcMW2QmdEufbnvNb33V0lW00KjkC4)
  - `1. Documentos` — canvas de onboarding e planilha de acessos
...
- ClickUp (tarefas ativas):
  ...
  - [Preparar roadmap e validar com Daniel](https://app.clickup.com/t/86bay5bd4) — a fazer
  - [Agendar call de consultoria de SS (Ceci)](https://app.clickup.com/t/86baqm43g) — em progresso
...
- Oferta high ticket: mentoria em grupo de 6 meses, R$ 4.497 (âncora R$ 6.000);
  downsell de 3 meses por R$ 3.498. Entrega via Kiwify + encontros semanais ao vivo.
- A expert vendia ~R$ 30 mil/mês no 1-a-1, sem tráfego, com ~70% de conversão
  nas sessões de diagnóstico — o funil deve alavancar esse diagnóstico.
