...
| 2026-07-17 | Roadmap 90 dias criado (v1.0, skill roadmap-estrategico-90-dias). Perfil A híbrido: João executa com direcionamento da Simple, mas funil de quiz entra cedo (dias 15 a 60) pela urgência. Meta: 10 vendas/mês × R$ 4.497 = R$ 45k/mês; conversão assumida 50% (declarada: 70%) = 20 sessões/mês; agenda da Luana assumida em até 2 sessões/dia. Bônus dia 60+: marca @ojomes + captação de experts da saúde. Premissas a validar com Daniel na call de roadmap. | Roadmap v1.0 |
