# Aprendizados — Ana Carla Henriques (Blindecell)

Log do que funciona e do que não funciona com este cliente.

| Data | Aprendizado / decisão | Origem |
| ---------- | --------------------- | ------ |
| 2026-08-13 | Fecharam por medo de perder o "oceano azul" (ninguém oferece blindagem na cidade), não por promessa de resultado. O argumento que destravou foi *"e se alguém começar a vender esse produto antes de vocês?"*. | Call de vendas |
| 2026-08-13 | Caixa curto e sensível: negociaram a entrada de R$ 5.000 para R$ 1.000, recusaram cartão de crédito, só Pix. Motivo declarado: motor de um carro da outra empresa do Cleomar. Evitar qualquer custo-surpresa — inclusive a verba de mídia. | Call de vendas |
