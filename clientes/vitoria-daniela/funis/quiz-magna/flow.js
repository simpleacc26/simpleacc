...
window.FLOW = {
  ...
  /* Ordem e texto EXATAMENTE como a Vitória deixou no doc "QUIZ" (aba QUIZ
     GENÉRICO, atualização de 25/09/2026): segmento entra como 1ª pergunta,
     ticket médio saiu e faturamento vem antes da urgência. */
  steps: [
    {
      id: "segmento",
      etapa: "Seu segmento",
      pergunta: "Qual seu segmento de atuação?",
      options: [
        { value: "saude", label: "Saúde (médica, dentista, nutricionista, fisioterapeuta, psicóloga...)" },
        { value: "estetica", label: "Estética, beleza e bem-estar (clínica, studio, estúdio fitness...)" },
        { value: "juridico", label: "Advocacia e área jurídica" },
        { value: "arquitetura", label: "Arquitetura ou engenharia" },
        { value: "consultoria", label: "Consultoria, mentoria ou educação" },
        { value: "marketing", label: "Marketing" },
        { value: "financas", label: "Finanças, contabilidade e outros" },
    ...
    },
    {
      ...
      options: [
        ...
        { value: "digital-precisa-escalar", label: "Já vendo com consistência no digital, mas preciso escalar meu negócio." },
      ],
    },
    {
      id: "estrutura",
  ...
  getCamada(answers) {
    ...
    if (temEquipe) return "A"; // 40 mil+ com equipe (o ticket médio saiu do quiz)
    return "B";
  },
};
