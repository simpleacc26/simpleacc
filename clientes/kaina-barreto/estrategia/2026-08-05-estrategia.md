...
**O negócio em uma linha:** consultoria online de treino e nutrição (Shape10X) que destrava quem já treina com constância e parou de ver o corpo responder.

**Frente única:** consultoria anual Shape10X. Não há split de mídia — 100% do investimento vai para uma oferta só, por decisão estratégica dos primeiros 90 dias.
...
Só que o corpo não responde a esforço. Responde a **estímulo novo no momento certo**. O ciclo que funcionou seis meses atrás virou manutenção hoje, e manutenção não muda ninguém. O erro é invisível porque ele não está no que a pessoa faz — está no que ninguém ajustou.

É por isso que trocar de treino sozinho não resolve: troca o exercício, mantém a lógica. E é por isso que a pessoa mais disciplinada da academia pode passar um ano inteiro sem sair do lugar.

**A virada de chave:** o problema quase nunca é disciplina. É ajuste.
...
### 3. Problema · O que mais te incomoda hoje?
- Eu treino, mas o espelho não muda
- Estanquei na carga, não evoluo mais
...
- Mexi só na alimentação

### 7. Objetivo · Se destravasse nos próximos 90 dias, qual seria a maior conquista?
- Ver o corpo enfim refletir o esforço que eu já faço
- Ganhar massa de verdade
...
- Talvez, quero entender melhor antes
...
`[ANTES E DEPOIS 1]` · `[ANTES E DEPOIS 2]` · `[ANTES E DEPOIS 3]`

`[DEPOIMENTO 1 — prioridade para aluno que treinava há anos e estava travado]`
`[DEPOIMENTO 2 — prioridade para aluno com rotina apertada]`
...
## Reframe — o mecanismo do problema

Todo mundo te ensinou que resultado é disciplina. Então, quando o corpo para, a única saída que aparece é fazer mais: mais série, mais dia, menos comida.
...
## Autoridade — quem vai te acompanhar

**Kainã Barreto**, personal trainer há `[ANOS DE ATUAÇÃO]` e atleta de powerbuilding com **total de 600 kg**.

Ele cobra de si exatamente o que ensina. Não é teoria de quem só estudou: é o método que ele aplica no próprio treino, todos os dias, e que hoje acompanha alunos no presencial em Pelotas e no online em todo o Brasil.
...
## Ângulo 1 — Identidade e dor

**Estratégia:** falar a frase que a pessoa fala pra si mesma e nunca disse em voz alta. É o ângulo com o melhor sinal orgânico da conta dele (o Reel de identidade fez 2.359 visualizações contra mediana perto de 450).
...
## Ângulo 2 — O erro invisível (mecanismo)

**Estratégia:** entregar valor real e criar a percepção de um erro que a pessoa não sabia que cometia. É o formato que ele já produz bem e que gera comentário.

**Hook:**
"O erro invisível de quem treina certo e mesmo assim não muda."
...
**Copy longa (~250 palavras):**
O erro invisível de quem treina certo e mesmo assim não muda.
Vou ser direto: na maioria das vezes que alguém chega travado até mim, não tem nada de errado com o esforço da pessoa. Ela treina. Ela come razoavelmente bem. Ela é constante.
O erro está em outro lugar, e é por isso que ele é invisível.
Ela está seguindo o mesmo ciclo depois que o corpo já se adaptou a ele.
Funciona assim: todo estímulo tem prazo de validade. O treino que te fez evoluir seis meses atrás cumpriu o papel dele e virou manutenção. Manutenção mantém, não transforma. E como o esforço não caiu, ninguém desconfia do treino. A pessoa desconfia de si mesma.
...
## Ângulo 3 — Prova e transformação

**Estratégia:** identificação por resultado de gente igual à pessoa, não de atleta. O ICP não quer virar fisiculturista, então a prova precisa ser de alguém com rotina normal.

**Hook:**
"Ela treinava há 4 anos e não via mudança. Mudou uma coisa só."

**Copy curta (~50 palavras):**
`[NOME DO ALUNO]` treinava há anos e não via mudança nenhuma.
...
Não era falta de esforço: ela treinava `[X]` vezes por semana, seguia a dieta, fazia tudo que mandaram.
...
**Copy longa (~250 palavras):**
`[NOME DO ALUNO]` chegou pra mim depois de `[TEMPO]` anos treinando sem ver o corpo mudar.
E olha: não era descaso. Ela treinava `[X]` vezes por semana, tinha rotina apertada de `[CONTEXTO]`, e mesmo assim não faltava. Seguia a alimentação de segunda a sexta. Fazia tudo o que já tinham mandado ela fazer.
O que ela me disse na primeira conversa foi mais ou menos isso: "eu faço tudo certo, então por que não funciona?"
A gente não aumentou o treino dela. Não cortou mais comida. Não colocou cardio em jejum.
...
*(entregue automaticamente após o quiz)*

## Instruções de uso

- Substituir todas as variáveis `{{}}` pelas respostas do quiz.
- `[DEPOIMENTO]` e `[ANTES E DEPOIS]`: inserir prova real. **Nunca inventar caso.**
- Botões `[AGENDAR]` levam para o WhatsApp com mensagem pronta.
- **Tom:** direto, na voz do Kainã, sem condescendência e sem tom de palestra. A pessoa é disciplinada e sabe disso — o relatório existe para nomear a causa, não para motivar.
- **Regra inegociável:** em nenhum ponto o texto pode sugerir falta de esforço.
...
**ETAPA 6 · O que destrava (mecanismo da solução)**
...
`[ANTES E DEPOIS — aluno com perfil parecido]`

`[DEPOIMENTO — priorizar quem treinava há anos e destravou]`
...
| Nível | Situação | Postura |
| --- | --- | --- |
| **N1** | Fez o quiz e não respondeu nada | Reengajar pelo diagnóstico, nunca pela oferta |
| **N2** | Respondeu, engajou e sumiu | Retomar exatamente de onde parou, citando a resposta dele |
| **N3** | Quer agendar mas adia | Facilitar ao máximo: propor 2 horários fechados |
| **N4** | No-show na avaliação | Sem cobrança, sem culpa. Reoferecer uma vez |
| **N5** | Fez a avaliação e não fechou | Tratar a objeção real, não repetir a oferta |
| **N6** | Relacionamento longo (não é o momento) | Cadência mensal de valor, sem oferta |
...
**Depois do dia 12:** o lead vai para a cadência N6 (relacionamento). Uma mensagem por mês, sempre de valor, nunca de oferta.
...
- [ ] Verba de R$ 1.000 separada sem sair do bolso dele
- [ ] Preço oficial do anual decidido e registrado
- [ ] Oferta em uma página + PDF de apresentação prontos
- [ ] Quiz no ar e link da bio trocado
- [ ] Planilha de leads com origem marcada, viva
- [ ] 3 criativos aprovados e campanha rodando
- [ ] Cadência de 12 dias implantada
- [ ] Calls sendo gravadas e revisadas

---

# 8. RECOMENDAÇÕES ESTRATÉGICAS (Simple)

## Sobre o funil — o gargalo não é onde ele acha que é

Kainã chegou achando que precisava melhorar como vende. Os números dizem outra coisa: **12 a 14 calls, ~30% de conversão, e horas de agenda reservadas que ele não consegue preencher.** Isso é gargalo de entrada, não de fechamento.

**Consequência prática:** não gastar as 12 semanas de mentoria treinando pitch. Se ele mantiver 30% e a agenda encher, a meta sai sozinha. Se ele melhorar o pitch e a agenda continuar vazia, não muda nada.

**O buraco mais barato de tapar:** o link da bio vai direto para o WhatsApp, sem nenhum filtro. Todo mundo entra e ele vira o filtro humano — ele mesmo disse que hoje "marca reunião com todo mundo". O quiz resolve isso em uma semana de trabalho.

## Sobre a oferta — não subir preço antes da hora

A regra combinada na call foi subir o anual para R$ 4 a 5 mil quando a conversão passar de 30%. **Ele já está em ~30%, mas numa amostra de 12 a 14 calls.** Isso não é conversão, é coincidência estatística.

**Recomendação:** manter R$ 2.000 até ter 30 calls ou mais vindas do funil. Subir cedo, com lead frio de tráfego e sem prova social estruturada, derruba a conversão e ainda tira dele a única coisa que está funcionando hoje.

**Pendência que trava a copy:** o preço oficial precisa ser definido. Canvas diz R$ 1.800, call diz R$ 2.000. Não dá para escrever página de vendas com dois preços em circulação.

## Sobre conversão — o que mais vai render

1. **Fechar dentro da call.** Ele perdeu pelo menos uma venda anual porque a pessoa saiu "pra ver o cartão". Isso não é objeção de preço, é objeção de momento, e some quando o pagamento é resolvido ali na tela.
2. **Downsell é mais barato, não mais curto.** Ele estava desenhando a esteira por duração de plano. Um trimestral pelo preço proporcional não rentabiliza a call, só antecipa o churn.
3. **A garantia é subusada.** Continuar treinando de graça com 80% de aderência é o argumento mais forte que ele tem contra um público cético por acúmulo de tentativa, e hoje isso não aparece em lugar nenhum na comunicação dele.

## Sobre o risco do projeto — o que pode fazer isso não acontecer

**1. Caixa.** Ele paga duas mentorias ao mesmo tempo e precisa de R$ 1.000 de mídia. Foi a maior objeção da call de vendas e é o risco número um. Por isso o caixa rápido vem antes de tudo: se essa fase não fechar até o dia 10, **não subir campanha** — resolver o caixa primeiro.

**2. Burnout.** Ele chegou trabalhando 16 horas por dia e usou a palavra. Esse não é um detalhe de personalidade, é um risco de execução: foi o que fez ele largar o social selling e perder alunos do presencial. Toda entrega precisa vir em passo único e sequencial. Se ele estiver executando três frentes ao mesmo tempo, alguém do time tem que mandar ele parar duas.

**3. Comparação com a mentoria anterior.** Ele vai medir a Simple contra os R$ 12 mil que não resolveram. **Uma vitória rápida e visível vale mais que profundidade teórica.** A primeira métrica real do funil, mesmo modesta, é o que vai segurar ele nos primeiros 30 dias.

## Visão de longo prazo — onde está o dinheiro que ele não está vendo

Ele tem um ativo que quase nenhum concorrente tem: **capacidade de entrega ociosa.** O app de IA que ele mesmo montou entrega um plano individual em 5 minutos. Isso significa que ele pode multiplicar alunos sem multiplicar carga operacional — cada aluno a mais entra com margem quase cheia.

Três desdobramentos, na ordem:

1. **Expansão de valor (dia 60):** afiliação de suplemento e roupa, mais programa de indicação. Receita sem custo de aquisição, em cima de uma base que ele já tem.
2. **Reposicionamento de ticket (dia 90):** com conversão medida em volume, o anual sobe e o plano de hoje vira o degrau de baixo.
3. **Produto de mentoria (fora destes 90 dias):** quando ele bater os R$ 20 mil, ele passa a ter a coisa mais vendável do mercado dele — um personal que resolveu a própria aquisição. Isso é o Roadmap 3, não agora.

**O que não fazer:** criar produto novo antes de fechar 5 vendas do anual pelo funil. Produto novo, no perfil dele, é fuga disfarçada de estratégia — e ele já demonstrou essa tendência quando montou o sistema de entrega antes de ter demanda para entregar.
