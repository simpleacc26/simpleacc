# Cliente: Eliana Franz

Esta pasta é a **base de conhecimento** do cliente Eliana Franz. Tudo que a SimpleAcc
...
4. Trabalhe numa branch `cliente/eliana-franz/<assunto>` e abra PR.
