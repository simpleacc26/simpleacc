# Cliente: Carol e José

Esta pasta é a **base de conhecimento** do cliente Carol e José. Tudo que a SimpleAcc
...
4. Trabalhe numa branch `cliente/carol-e-jose/<assunto>` e abra PR.
